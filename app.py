...
<div class="main-header">
    ...
    <p>Tác giả: Lê Thị Liễu - Trường PTDTBT Tiểu học Mậu Long, xã Mậu Duệ - ĐT: 0855941539</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Lê Thị Liễu - Trường PTDTBT Tiểu học Mậu Long, xã Mậu Duệ - ĐT: 0855941539</div>", unsafe_allow_html=True)
